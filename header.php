                ...
                <div class="col-lg-8 col-md-12">
                    <ul class="middle-header-content">
                        ...
                        <li>
                            ...
                            <span>506-507,ITL Northex Tower,A09 Netaji <br>Subhash Place,Pitampura, Delhi-110034</span>
                        </li>
                        <li>
                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="our-doctors.php" class="nav-link">Our Doctors</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="others-options d-flex align-items-center">
                            <div class="option-item">
                                <div class="navbar-btn">
                                    <a href="index.php#goto" class="default-btn">Book Appointment</a>
                                </div>
                            </div>
                        </div>
                    </div>
